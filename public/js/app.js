...
var buttonArray = [];
var partsArray = [];
window.axios.get("/map/" + window.location.href.split("/")[6]).then(function (_ref) {
  var data = _ref.data;
...
function drawPlayerFieldOfView() {
  ...
  ctx.fill();
  ctx.fillStyle = "#383838"; //ctx.globalCompositionOperation = 'xor';
...
__webpack_require__(/*! C:\Entwicklung\Lost-Shapes\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Entwicklung\Lost-Shapes\resources\sass\app.scss */"./resources/sass/app.scss");
